...
Function Get-PendingReboot {
	...
	# HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\WindowsUpdate\Auto Update\RebootRequired
	Get-RegValue -ComputerName $ComputerName -SubScripts $SubScripts -Assets $Assets -HKey $HKey -SubKey $SubKey_AutoUpdate
	...
	# HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\WindowsUpdate\Auto Update\RebootRequired
	Get-RegValue -ComputerName $ComputerName -SubScripts $SubScripts -Assets $Assets -HKey $HKey -SubKey $SubKey_CBS
	If ($global:GetRegValue.Success -eq $true) {
...
#	}
	...
	Get-RegValue -ComputerName $ComputerName -SubScripts $SubScripts -Assets $Assets -HKey $HKey -SubKey $SubKey_SessionManager
	If ($global:GetRegValue.Success -eq $true) {
	...
	Get-RegValue -ComputerName $ComputerName -SubScripts $SubScripts -Assets $Assets -HKey $HKey -SubKey $SubKey_ServerManager -String $String_Reboot_Attempts
	...
	Get-RegValue -ComputerName $ComputerName -SubScripts $SubScripts -Assets $Assets -HKey $HKey -SubKey $SubKey_ActiveComputerName -String $String_ComputerName
	If ($global:GetRegValue.Success -eq $true) {
	...
	Get-RegValue -ComputerName $ComputerName -SubScripts $SubScripts -Assets $Assets -HKey $HKey -SubKey $SubKey_ComputerName2 -String $String_ComputerName
	If ($global:GetRegValue.Success -eq $true) {
